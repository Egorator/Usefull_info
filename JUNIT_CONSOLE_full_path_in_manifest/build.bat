...
javac -cp C:\JUnit\junit-4.10.jar;C:\JUNIT_WORKSPACE\Home\Egor Home\Egor\TestRunner2.java Home\Egor\TestAssertions.java || pause && exit \b

::java -cp C:\JUnit\junit-4.10.jar;. Home.Egor.TestRunner2
